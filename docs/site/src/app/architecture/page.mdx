...
Full reasoning for every decision on this page, including the ones that were tried and reverted, is in [`docs/DECISIONS.md`](https://github.com/IMIO/imio.emailkit/blob/main/docs/DECISIONS.md).
