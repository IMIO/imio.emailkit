...
function ResourcePattern({ mouseX, mouseY, ...gridProps }) {
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-linear-to-r from-accent-50 to-accent-100 opacity-0 transition duration-300 group-hover:opacity-100 dark:from-accent-950 dark:to-accent-900/60"
        style={style}
      />
      <motion.div
