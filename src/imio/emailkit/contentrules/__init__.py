"""The content-rule action, and nothing else.
...
**This package is a caller of the builder, not a part of it.** The executor's whole body
...
right, not an oversight: the opt-out is about not restyling Plone's *stock
